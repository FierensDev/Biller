...
export class Datas implements HasHtmlFormat {
  ...
  private subTotal(price: number, tva: number, quantity: number){
  ...
  htmlFormat(): string {
    ...
    const totalPrice: number = this.subTotal(this.price, this.tva, this.quantity)
    ...
    <div class="row pb-5 p-5">
        <div class="col-sm-6 text-left">
            <p class="font-weight-bold">Entreprise de Deuns</p>
            <p class="mb-1">22 boulevard en bas de chez moi</p>
            <p>75001 - Paris</p>
